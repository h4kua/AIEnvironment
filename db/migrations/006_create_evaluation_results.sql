...
CREATE INDEX IF NOT EXISTS idx_evaluation_status     ON evaluation_results(system_status);
CREATE INDEX IF NOT EXISTS idx_evaluation_risk       ON evaluation_results(risk_level);
CREATE INDEX IF NOT EXISTS idx_evaluation_confidence ON evaluation_results(confidence_score);
